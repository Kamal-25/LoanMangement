...
public class CustomerService {
	...
	public CustomerMaster updateCustomer(Long custId, CustomerMaster updatedCustomer) {
		...
		existingCustomer.setnidCard(updatedCustomer.getnidCard());
	...
	public void validateCustomerData(CustomerMaster customer) {
		...
		validateUniquenidCard(customer.getnidCard());
	...
	//nidCard Validation
	private void validateUniquenidCard(int nidCard) {
		CustomerMaster existingCustomer = customerMasterRepo.findByNidCard(nidCard);
		if (existingCustomer != null) {
			throw new DuplicateAccountException("Duplicate account with Nid Card: " + nidCard);
		}
	}
